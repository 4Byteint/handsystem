...
void GraspPose_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) robot_interfaces::msg::GraspPose(_init);
}

void GraspPose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_interfaces::msg::GraspPose *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GraspPose_message_members = {
  ...
  GraspPose_fini_function  // function to terminate message instance (will not free memory)
};

static const rosidl_message_type_support_t GraspPose_message_type_support_handle = {
  ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  &GraspPose_message_members,
...
{
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::GraspPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces, msg, GraspPose)() {
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::GraspPose_message_type_support_handle;
}
